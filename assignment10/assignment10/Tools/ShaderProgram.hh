...
public:
    ShaderProgram(const std::string& vertexShaderName, const std::string& fragmentShaderName)
      : mObjectName(0), mVertexShader(vertexShaderName, GL_VERTEX_SHADER), mFragmentShader(fragmentShaderName, GL_FRAGMENT_SHADER)
    {
    ...
    ~ShaderProgram() { glDeleteProgram(mObjectName); }
