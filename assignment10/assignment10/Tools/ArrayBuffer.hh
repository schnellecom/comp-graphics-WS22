...
public:
    ...
    // ========================================================================================================= \/
public:
    ArrayBuffer() : Buffer(GL_ARRAY_BUFFER), mStride(0), mAttributes() {}
...
public:
    ...
    inline void setTarget(GLenum) { std::cerr << "DON'T redefine the target binding point of an ArrayBuffer" << std::endl; }
