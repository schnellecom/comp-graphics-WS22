...
public:
    ...
    // ========================================================================================================= \/
public:
    VertexArrayObject() : mObjectName(0), mMode(GL_TRIANGLES), mAttributes() { glGenVertexArrays(1, &mObjectName); }
...
public:
    ...
    {
        for (AttributeVec::const_iterator it = mAttributes.begin(), it_end = mAttributes.end(); it != it_end; ++it)
        {
...
public:
    //! Bind this VAO
    inline void bind(void) const { glBindVertexArray(mObjectName); }
    ...
    void draw(void) const { drawArrays(); }
    ...
    //! Can be called directly instead of draw() iff the caller knows this is the correct call!
    inline void drawArrays(void) const { glDrawArrays(mMode, 0, mAttributes[0].arrayBuffer->getElements()); }
