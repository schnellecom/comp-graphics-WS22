...
void GenericCamera::setRotationMatrix(glm::mat3 _matrix) { mRotationMatrix = _matrix; }

void GenericCamera::setRotationMatrix(glm::mat4 _matrix) { mRotationMatrix = glm::mat3(_matrix); }
...
float GenericCamera::getFocalLenghtInPixel() const { return ((float)mViewportSize.x) / (2.0f * tan(calcDegToRad(0.5f * mHorizontalFieldOfView))); }
